...
namespace Handee.Controllers
{
    public class ContractsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Note,Hid,Imagepath")] Contract contract)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Note,Hid,Imagepath")] Contract contract)
        {
            if (id != contract.Hid)
            {
                return NotFound();
