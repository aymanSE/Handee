...
namespace Handee.Controllers
{
    public class VisasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Pin,Pass,Exp,Userid")] Visa visa)
        {
            ...
            ViewData["Userid"] = new SelectList(_context.Userrs, "Userid", "Userid", visa.Userid);
            return View(visa);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Pin,Pass,Exp,Userid")] Visa visa)
        {
            if (id != visa.Id)
            {
                return NotFound();
